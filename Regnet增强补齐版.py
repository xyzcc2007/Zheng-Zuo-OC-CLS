...
class RegNetGroupPredictionModel(nn.Module):
    ...
    def forward(self, x, roi_masks=None, device_domains=None, return_features=False, 
        ...
        for i in range(num_images):
            ...
            feat = self.backbone(current_image, current_mask)
...
def get_args():
    ...
    parser.add_argument('--val_batch_size', default=4, type=int, help='Val/Test batch size')
    ...
    # ROI约束参数
    parser.add_argument('--roi_penalty_lambda', default=1.0, type=float, help='ROI区域外惩罚损失权重')
    
    # 数据增强参数保持不变 #
    parser.add_argument('--augment', default=['brightness(0.7,1.3)', 
                                             'blur5','contrast(0.7,1.3)','sharpness(0.7,1.3)'], 
    ...
    parser.add_argument('--weight_0', default=1.0, type=float, help='Weight for class 0')
    parser.add_argument('--weight_1', default=1.0, type=float, help='Weight for class 1')
    
    # Focal Loss参数
    parser.add_argument('--focal_loss', action='store_true', default=True, help='Use focal loss')
    parser.add_argument('--focal_alpha', default=0.40, type=float, help='Focal loss alpha')
    parser.add_argument('--focal_gamma', default=1.2, type=float, help='Focal loss gamma')
    ...
    parser.add_argument('--patience_stop', default=20, type=int, help='Early stopping patience')
    ...
    parser.add_argument('--dropout', default=0.45, type=float, help='Dropout rate')
