...
def get_pure_inference_args():
    ...
    parser.add_argument('--model_path', 
                       default="/gpu-dir/ZCC/Radiomics/group_train_log/cyst_oc/regnety_032/2025-07-02/P1D1.5/cv1/best_model.pth",
    ...
    parser.add_argument('--log_root', default='/gpu-dir/ZCC/Radiomics/test_log/regnet_domain_inference/szl/Ablation experiment')
